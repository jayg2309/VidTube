...
const updateAccountDetails = asyncHandler(async (req, res) => {
  ...
  const user = await User.findByIdAndUpdate(
    ...
    { new: true } // you want updated info to come
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  //using aggregation pipelines -- all pipelines are objects {}
  ...
  const channel = await User.aggregate([
    ...
    {
      //find more information - collect all channels with my id and those are my subscribers
      $lookup: {
        from: "subscriptions",
        localField: "_id",
    ...
    {
      //all the channels that I have subscribed to
      $lookup: {
        from: "subscriptions",
        localField: "_id",
    ...
    {
      //present the information as an added field
      $addFields: {
        subscribersCount: {
          $size: "$subscribers", //line 385 one , $ sign required when you have named something
        },
        ...
        isSubscribed: {
          $cond: {
            // find user with _id if present in subscribers nu subscriber document
  ...
  // if agg pipeline executed successfully - data in array form
